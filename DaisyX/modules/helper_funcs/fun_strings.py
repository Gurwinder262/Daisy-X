...
TRUTH = (
    "Apakah Anda memilih hidung Anda?",
    ...
    "Pernahkah Anda masuk pada orang tua Anda melakukan 'itu'?",
    ...
    "Apa satu hal yang kamu takut untuk kehilangan?",
    ...
    "Apakah Anda pikir Anda akan menikahi pacar Anda saat ini?",
    "Maukah Anda menukar saudara Anda dengan satu juta dolar?",
    "Maukah Anda Menampar Teman Terbaik Anda Untuk Sejuta Dolar?", 
    ...
    "menggambarkan pasangan sempurna Anda.",
    ...
    "Jika teman dan pacar Anda sama-sama sekarat di depan Anda, siapa yang akan mencoba menyelamatkan lebih dulu?",
    ...
    "Kya Apke Pasta Gigi Me Namak Dia?",
    "Rasode Me Kon Tha?",
    ...
    "Siapa yang lebih panas? Kamu atau temanmu?",
    "Siapa yang Bodoh?\n (A. Temanmu\n (B. Kamu",
...
DARE = (
    ...
    "*Berteriak kata pertama yang muncul di pikiran Anda",
